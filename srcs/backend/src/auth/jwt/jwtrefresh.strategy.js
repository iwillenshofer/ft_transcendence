...
var JwtRefreshStrategy = /** @class */ (function (_super) {
    ...
    function JwtRefreshStrategy(userService, jwtService) {
    ...
    JwtRefreshStrategy.prototype.validate = function (req, payload) {
        return __awaiter(this, void 0, void 0, function () {
            var refreshtoken, err_1, user_refreshtoken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        refreshtoken = req === null || req === void 0 ? void 0 : req.cookies['refresh_token'];
                        if (!payload || !(refreshtoken))
                            throw new common_1.UnauthorizedException;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.jwtService.verify(refreshtoken, { secret: process.env.JWT_REFRESH_SECRET })];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        err_1 = _a.sent();
                        throw new common_1.UnauthorizedException;
                    case 4: return [4 /*yield*/, this.userService.getRefreshToken(payload.id)];
                    case 5:
                        user_refreshtoken = _a.sent();
